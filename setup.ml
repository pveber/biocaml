...
(* OASIS_START *)
(* DO NOT EDIT (digest: c629b69c50ac499ea7b820d2a3383ef1) *)
(*
...
# 21 "/tmp/buildd/oasis-0.2.0/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
     ...
     doc = [("doclib", OCamlbuildDocPlugin.doc_build "src/lib/")];
     ...
     clean_doc = [("doclib", OCamlbuildDocPlugin.doc_clean "src/lib/")];
     distclean = [];
     distclean_test =
       [
          ("main",
     ...
     package =
       {
          ...
          homepage = Some "http://biocaml.org";
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/ext/xmlm-1.0.2/src/";
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "biocamlxmlm";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gff_to_bed.ml"; });
               Library
                 ({
                     cs_name = "biocaml_wrappers";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Biocaml_wrappers"];
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "biocaml";
                      lib_findlib_name = Some "wrappers";
                      lib_findlib_containers = [];
                      });
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Biocaml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gff_counts.ml"; });
               Executable
                 ({
                     cs_name = "wig_correlate";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "wig_correlate.ml"; });
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gff_to_table.ml"; });
               Executable
                 ({
                     cs_name = "sgr_to_wig";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sgr_to_wig.ml"; })
            ];
          plugins =
